...
export const NewChatSidebar = () => {
    ...
    return (
        <aside className={`fixed top-0 ${theme.newChatSidebar.status ? 'translate-x-0' : '-translate-x-full'} duration-300 flex-col flex left-0 z-[200] h-screen w-[420px] bg-base-200`}>
